...
import { Menu, X, ScanSearch, UserCheck, Activity, ShoppingBag, Video, Film } from 'lucide-react'
            ...
            >
                ...
                >
                    <nav className="flex flex-col gap-1 text-base font-medium pb-8">
                        ...
                        <Link href="/movie-scene-finder" onClick={close} className="flex items-center gap-3 py-3 px-3 rounded-lg hover:bg-muted transition-colors">
                            <Film className="w-5 h-5 text-purple-500" />
                            <span className="font-bold text-purple-500">Video Clips Vault</span>
                        </Link>
                        <Link href="/ai-tools/reels-architect" onClick={close} className="flex items-center gap-3 py-3 px-3 rounded-lg hover:bg-muted transition-colors">
                            <Video className="w-5 h-5 text-rose-500" />
                            <span className="font-bold text-rose-500">Reels Architect</span>
                        </Link>
